  ...
  return (
    <SvgIcon {...props} viewBox="0 0 20 20">
      <defs>
        ...
        <linearGradient id={svgIds[2]} x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#181820" />
          <stop offset="100%" stopColor="#0A0A0E" />
        </linearGradient>
        <circle id={svgIds[4]} cx="10.313" cy="10.375" r="9.375" />
      </defs>
      <g fill="none" fillRule="evenodd">
        ...
        />
        <mask id={svgIds[3]} fill="#fff">
          <use xlinkHref={`#${svgIds[4]}`} />
        </mask>
        <use fill={`url(#${svgIds[2]})`} xlinkHref={`#${svgIds[4]}`} />
        <path
          fill={`url(#${svgIds[0]})`}
          stroke="#0A0A0E"
          strokeWidth=".5"
