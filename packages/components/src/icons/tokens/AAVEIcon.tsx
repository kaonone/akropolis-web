...
export function AAVEIcon(props: React.ComponentProps<typeof SvgIcon>) {
  return (
    <SvgIcon {...props} viewBox="0 0 20 20">
      <defs>
        <linearGradient id="s9qrkht62a" x1="8.586%" x2="100%" y1="96.414%" y2="26.414%">
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          <g transform="translate(-648 -6757) translate(648 6757)">
            <rect width="20" height="20" fill="url(#s9qrkht62a)" rx="10" />
            <path
              fill="#FFF"
