...
function delphiPoolIcon(props: React.ComponentProps<typeof SvgIcon>) {
  return (
    <SvgIcon {...props} viewBox="0 0 20 20">
      <defs>
        ...
        <radialGradient
          ...
          fx="31.236%"
          fy="42.426%"
          gradientTransform="scale(.83098 1) rotate(-47.596 .344 .352)"
        >
          <stop offset="0%" stopColor="#594AFF" />
          <stop offset="100%" stopColor="#3B2ECE" />
        </radialGradient>
        <linearGradient id="nx60cshwgc" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#181820" />
          <stop offset="100%" stopColor="#0A0A0E" />
        </linearGradient>
        <circle id="6aighe079b" cx="10.313" cy="10.375" r="9.375" />
      </defs>
      <g fill="none" fillRule="evenodd">
        <g>
          <g>
            <g transform="translate(-648 -6847) translate(648 6847)">
              ...
              />
              <mask id="ciqygxgx1e" fill="#fff">
                <use xlinkHref="#6aighe079b" />
              </mask>
              <use fill="url(#nx60cshwgc)" xlinkHref="#6aighe079b" />
              <path
                fill="url(#208aad0byd)"
                stroke="#0A0A0E"
                strokeWidth=".5"
