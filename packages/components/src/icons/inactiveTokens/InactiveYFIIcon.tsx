...
export function InactiveYFIIcon(props: React.ComponentProps<typeof SvgIcon>) {
  return (
    <SvgIcon {...props} viewBox="0 0 20 20">
      <g fill="none" fillRule="evenodd">
        <g>
          <g transform="translate(-960 -6757) translate(960 6757)">
            <circle cx="10" cy="10" r="10" fill="#191924" />
            <path fill="#FFF" fillRule="nonzero" d="M9.565 5.718H10.565V14.166H9.565z" />
            <path
              fill="#FFF"
              fillRule="nonzero"
