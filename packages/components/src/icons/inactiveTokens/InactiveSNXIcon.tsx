...
export function InactiveSNXIcon(props: React.ComponentProps<typeof SvgIcon>) {
  return (
        ...
        <g>
          <g>
            <path
              ...
              transform="translate(-960 -6656) translate(960 6656)"
            />
            <g fill="#FFF">
              <path
                d="M1.041 8.697L0.14 8.054 5.806 0.182 6.706 0.825z"
                opacity=".5"
                transform="translate(-960 -6656) translate(960 6656) translate(6.6 5.2)"
              />
              <path
