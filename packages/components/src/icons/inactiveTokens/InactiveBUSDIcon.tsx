...
export function InactiveBUSDIcon(props: React.ComponentProps<typeof SvgIcon>) {
  return (
        ...
        <g fillRule="nonzero">
          <g>
            <path
              ...
              transform="translate(-1220 -6707) translate(1220 6707)"
            />
            <g fill="#FFF">
              <path
                ...
                transform="translate(-1220 -6707) translate(1220 6707) translate(3.394 3.394)"
              />
            </g>
          </g>
        </g>
