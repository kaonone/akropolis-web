...
export function InactiveDelphiPoolIcon(props: React.ComponentProps<typeof SvgIcon>) {
  return (
    <SvgIcon {...props} viewBox="0 0 20 20">
      <defs>
        <linearGradient id="wcz4rkuerb" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#181820" />
          <stop offset="100%" stopColor="#0A0A0E" />
        </linearGradient>
        <circle id="i4ssa8308a" cx="10.313" cy="10.375" r="9.375" />
      </defs>
      <g fill="none" fillRule="evenodd">
        <g>
          <g transform="translate(-961 -6847) translate(961 6847)">
            ...
            />
            <mask id="4fycay43hc" fill="#fff">
              <use xlinkHref="#i4ssa8308a" />
            </mask>
            <use fill="url(#wcz4rkuerb)" xlinkHref="#i4ssa8308a" />
            <path
              fill="#FFF"
              stroke="#0A0A0E"
              strokeWidth=".5"
