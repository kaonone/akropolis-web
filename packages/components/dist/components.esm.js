import React__default, { createElement, useMemo, useState, useCallback, Fragment, useRef, createContext, useContext, useEffect, PureComponent } from 'react';
import { repeat, mergeDeepRight, toString, memoizeWith } from 'ramda';
import cn from 'classnames';
import { makeStyles, useTheme, useAncestorBackgroundHack, createStyles, withStyles, useBreakpointsMatch, AncestorBackgroundHackProvider, rgba, lighten } from '@akropolis-web/styles';
...
import { TabList as TabList$1 } from '@material-ui/lab';
import TabScrollButton from '@material-ui/core/TabScrollButton';
import Tab$1 from '@material-ui/core/Tab';
import TabContext$1 from '@material-ui/lab/TabContext';
...
import { withStyles as withStyles$1, createStyles as createStyles$1 } from '@material-ui/styles';
import { mainnetTokens, AllCoinsToken, fromBaseUnit, toBaseUnit, LiquidityAmount, TokenAmount } from '@akropolis-web/primitives';
...
export { default as TextInput } from '@material-ui/core/TextField';
...
import Grid$1 from '@material-ui/core/Grid/Grid';
...
function BSCIcon(props) {
  return createElement(SvgIcon, Object.assign({}, props, {
    ...
    fill: "none",
    fillRule: "evenodd"
  }, createElement("g", null, createElement("g", {
...
function ADELIcon(props) {
  ...
  return createElement(SvgIcon, Object.assign({}, svgProps, {
    viewBox: "0 0 20 20"
...
function AKROIcon(props) {
  ...
  return createElement(SvgIcon, Object.assign({}, svgProps, {
    viewBox: "0 0 20 20"
  }), theme.gradients.main.svgLinear(gradientId), createElement("g", {
    fill: "none",
    fillRule: "evenodd"
  }, createElement("path", {
    d: "M0 0H20V20H0z"
...
function BALIcon(props) {
  ...
  return createElement(Icon, Object.assign({}, svgProps));
}
...
function InactiveCOMPIcon(props) {
  return createElement(SvgIcon, Object.assign({}, props, {
    viewBox: "0 0 20 20"
  }), createElement("g", null, createElement("circle", {
    cx: "10",
    cy: "10",
    r: "10",
    fill: "#191924"
...
function ActiveCRVIcon(props) {
  var gradientIds = useMemo(function () {
...
function USDTIcon(props) {
  ...
  return inactive ? createElement(TUSDIcon, Object.assign({}, props)) : createElement(ActiveUSDTIcon, Object.assign({}, svgProps));
}
...
function DelphiPoolIcon(props) {
  ...
  return createElement(SvgIcon, Object.assign({}, svgProps, {
    viewBox: "0 0 20 20"
  }), createElement("defs", null, createElement("radialGradient", {
    id: radialGradientID,
    cx: "31.236%",
    cy: "42.426%",
    r: "85.29%",
...
function CrvSBTCIcon(props) {
  return createElement(SvgIcon, Object.assign({}, props, {
    ...
    fill: "none",
    fillRule: "evenodd"
  }, createElement("g", null, createElement("g", null, createElement("g", null, createElement("path", {
    fill: "url(#sc037yydea)",
    fillRule: "nonzero",
...
function CrvCOMPIcon(props) {
  return createElement(SvgIcon, Object.assign({}, props, {
    ...
    fill: "none",
    fillRule: "evenodd"
  }, createElement("g", null, createElement("g", null, createElement("path", {
    fill: "#191B1F",
...
function SteCRVIcon(props) {
  return createElement(SvgIcon, Object.assign({}, props, {
    ...
    fill: "none",
    fillRule: "evenodd"
  }, createElement("g", null, createElement("g", null, createElement("circle", {
    cx: "16",
    cy: "16",
    r: "16",
    fill: "url(#pjphslc83a)"
...
function BTCIcon(props) {
  ...
  return inactive ? createElement(RenBTCIcon, Object.assign({}, props)) : createElement(ActiveBTCIcon, Object.assign({}, svgProps));
}
...
function ETHIcon(props) {
  ...
  return inactive ? createElement(WETHIcon, Object.assign({}, props)) : createElement(ActiveETHIcon, Object.assign({}, svgProps));
}
...
function Button(props) {
  var backgroundColor = useAncestorBackgroundHack();
  ...
  return createElement(Button$1, Object.assign({}, rest, {
...
var getDefaultVariantOverrides = function getDefaultVariantOverrides() {
  return mergeDeepRight(getBaseOverrides(), {
    root: {
      overflow: 'hidden'
    },
    tabsListRoot: {
...
var getMinimalisticVariantOverrides = function getMinimalisticVariantOverrides() {
  return mergeDeepRight(getDefaultVariantOverrides(), {
    root: {
      display: 'flex'
    },
    tabsListRoot: {
...
var useDefaultStyles = /*#__PURE__*/makeStyles(function () {
  return getDefaultVariantOverrides();
}, {
  name: 'TabList'
});
var useMinimalisticStyles = /*#__PURE__*/makeStyles(function () {
...
function TabList(props) {
  ...
  }), React__default.createElement(TabList$1, Object.assign({}, props, {
    component: "div",
...
var TabsSectionComponent = /*#__PURE__*/withStyles(styles, {
  name: 'TabsSection'
})(function (props) {
  ...
  var isSmallMobile = useBreakpointsMatch({
    to: 'mobileMD'
  });
...
function Metric(props) {
  ...
  return createElement("div", {
    ...
    className: classes.value
  }, value, chart && createElement("div", {
    className: classes.chart
  }, chart)), subValue && createElement("div", {
...
var Label = function Label(props) {
  ...
  var handleTooltipClose = useCallback(function () {
    setIsOpen(false);
  }, []);
  var handleTooltipOpen = useCallback(function (event) {
    setIsOpen(true);
  ...
  }, icon && createElement(Fragment, null, icon, "\xA0"), children, renderTooltip(), withComingSoon && createElement("span", {
  ...
  function renderTooltip() {
    return hint && createElement(Fragment, null, "\xA0", createElement(ClickAwayListener, {
      ...
      placement: "right"
    }, createElement("span", null, createElement(InfoIcon, {
...
function AddressIcon(props) {
  ...
  return createElement(SvgIcon, Object.assign({}, rest, {
    viewBox: "0 0 40 40",
    x: "0",
    y: "0",
    classes: {
...
function ShortAddress(props) {
  ...
  var handleTooltipOpen = useCallback(function () {
...
var styles$1 = /*#__PURE__*/createStyles$1({
  resizeContainer: {
    position: 'relative',
    flex: '1 1 1rem'
  },
...
var ResizeObserverComponent = /*#__PURE__*/withStyles$1(styles$1)(ResizeObserverContainer);
...
function Card(props) {
  ...
  return React__default.createElement(AncestorBackgroundHackProvider, {
    backgroundColor: backgroundColor
  }, React__default.createElement("div", {
...
var useStyles$9 = /*#__PURE__*/makeStyles(function (theme) {
  ...
  return {
    root: (_root = {
      ...
      border: "1px solid " + rgba(theme.palette.type === 'light' ? theme.colors.shark : theme.colors.white, theme.palette.type === 'light' ? 0.2 : 0.25),
...
var DependencyContext = /*#__PURE__*/createContext(null);
function useDependencyContext() {
  var context = useContext(DependencyContext);
...
function DependencyProvider(props) {
  var _props$supportedToken = props.supportedTokens,
      supportedTokens = _props$supportedToken === void 0 ? mainnetTokens : _props$supportedToken,
      children = props.children;
...
function TokenName(_ref) {
  ...
  return React__default.createElement(Grid, {
    ...
    item: true
  }, token instanceof AllCoinsToken && ((_token$tokens = token.tokens) === null || _token$tokens === void 0 ? void 0 : _token$tokens.length) ? token.tokens.map(function (_ref2) {
...
function TokensIcons(props) {
  ...
  return createElement("div", {
    ...
    return createElement("div", {
      ...
      key: address
    }, createElement(TokenIcon, Object.assign({}, iconsProps, {
      tokenAddress: address
    })));
  }));
}
...
function HiddenSvgDefs(props) {
  ...
  return createElement("svg", {
    className: classes.root
  }, createElement("defs", null, children));
}
...
function useAdapativeSpacing(spacing) {
  ...
  var adaptiveSpacing = useRef(typeof spacing === 'object' ? spacing : null).current;
  var prevSpacingRef = useRef(null);
  useEffect(function () {
    prevSpacingRef.current = spacing;
  }, [spacing]);
  var spacingString = toString(spacing);
  useEffect(function () {
    var isChangedAdaptiveSpacing = adaptiveSpacing && toString(adaptiveSpacing) !== spacingString;
  ...
  var sortSpacingByBreakpointValues = useCallback(function (spacingObject) {
  ...
  [toString(breakpoints)]);
  var sortedSpacing = useMemo(function () {
  ...
  var breakpointMatches = sortedSpacing.map(function (_ref3) {
    var key = _ref3[0];
    return useBreakpointsMatch({
      from: key
    });
  });
  var currentSpacing = useMemo(function () {
...
var useStyles$e = /*#__PURE__*/makeStyles(function () {
  return {
    root: {
      backgroundColor: function backgroundColor(_ref) {
        var _backgroundColor = _ref.backgroundColor;
        return lighten(_backgroundColor, 0.15);
      }
    }
  };
}, {
...
function NetworkIcon(props) {
  ...
  switch (network) {
    case 'bsc':
      return createElement(BSCIcon, Object.assign({}, rest));

    case 'eth':
    default:
      return createElement(ETHIcon, Object.assign({}, rest));
  }
}
...
var useStyles$f = /*#__PURE__*/makeStyles(function () {
  return {
    root: {
      boxShadow: 'none',
      '&$expanded': {
...
var useDefaultStyles$1 = /*#__PURE__*/makeStyles(function (theme) {
  return getDefaultVariantOverrides$1(theme);
}, {
  name: 'Tab'
});
var useMinimalisticStyles$1 = /*#__PURE__*/makeStyles(function (theme) {
...
var makeNumberInput = /*#__PURE__*/memoizeWith(toString, function (ownProps) {
  return function NumberFormatCustom(props) {
    ...
    return createElement(NumberFormat, Object.assign({}, ownProps, other, {
...
var NumberInput = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return createElement(TextInput, Object.assign({}, rest, {
...
function DecimalsInput(props) {
  ...
  var amount = useMemo(function () {
    return value && fromBaseUnit(value, baseDecimals) + suffix;
  ...
  var handleInputChange = useCallback(function (event) {
    ...
    if (inputValidationRegExp.test(event.target.value)) {
      ...
      var nextValue = toBaseUnit(event.target.value, baseDecimals).toString();
...
function CheckboxInput(props) {
  ...
  return createElement(FormControl, Object.assign({}, formControlProps), createElement(FormControlLabel, Object.assign({}, formControlLabelProps, {
    control: createElement(Checkbox, Object.assign({}, checkboxProps, {
      classes: {
        root: classes.root,
        disabled: classes.disabled,
      ...
      checkedIcon: createElement("span", {
        className: classes.icon
      }, createElement(CheckmarkIcon, {
        fontSize: "inherit"
      }))
    })),
    label: checkboxProps.required ? createElement(Fragment, null, label, ' *') : label
  })), helperText && createElement(FormHelperText, Object.assign({}, formHelperTextProps), helperText));
}
...
function RadioGroupInput(props) {
  ...
  var label = other.label,
      helperText = other.helperText;
  return createElement(FormControl, Object.assign({}, formControlProps), label && createElement(FormLabel, Object.assign({}, formLabelProps), label), createElement(RadioGroup, Object.assign({}, radioGroupProps)), helperText && createElement(FormHelperText, Object.assign({}, formHelperTextProps), helperText));
}
...
function RadioButton(props) {
  ...
  return createElement(Fragment, null, createElement(FormControlLabel, {
    control: createElement(Radio, Object.assign({}, radioProps, {
      checkedIcon: createElement("span", {
...
function SwitchInput(props) {
  ...
  return createElement(FormControl, Object.assign({}, formControlProps), createElement(FormControlLabel, {
    classes: {
      label: classes.label
    },
    control: createElement(Switch, Object.assign({}, switchProps, {
      classes: {
        root: classes.root,
...
function SelectInput(props) {
  ...
  var handleSelectOpen = useCallback(function () {
    setIsOpen(true);
  }, []);
  var handleSelectClose = useCallback(function () {
    setIsOpen(false);
  }, []);
  useEffect(function () {
  ...
  var menuPositionProps = useMemo(function () {
...
var useStyles$l = /*#__PURE__*/makeStyles(function (theme) {
...
function AmountInput(props) {
  ...
  var handleInputChange = useCallback(function (nextValue) {
  ...
  var handleCurrencyChange = useCallback(function (event) {
  ...
  var currencySelectOptions = useMemo(function () {
  ...
  var disabledInputProps = useMemo(function () {
...
function TokenAmountInput(props) {
  ...
  var tokens = useMemo(function () {
    return allowSelectAllToken && currencies.length > 1 ? [].concat(currencies, [new AllCoinsToken(currencies)]) : currencies;
  ...
  function getCurrencyLabel(currency) {
    return currency instanceof AllCoinsToken && currency.tokens ? React__default.createElement(Grid, {
      container: true,
      alignItems: "center",
      wrap: "nowrap"
...
var useStyles$m = /*#__PURE__*/makeStyles(function () {
  return {
    root: {
...
function DatepickerInput(props) {
  ...
  return createElement(MuiPickersUtilsProvider, {
    utils: DateFnsUtils
  }, createElement(KeyboardDatePicker, Object.assign({
    className: cn(classes.root, className),
    format: "MM/dd/yyyy",
    keyboardIcon: createElement(HistoryIcon, {
...
export { AAVEIcon, ADELIcon, AKROIcon, Accordion, AddressIcon, AlertIcon, AmountInput, Arrow, BALIcon, BSCIcon, BTCIcon, BUSDIcon, Button, COMPIcon, CRVIcon, Card, CheckboxInput, CheckmarkIcon, ComingSoon, CrvBUSDIcon, CrvCOMPIcon, CrvIBIcon, CrvSBTCIcon, CrvTricryptoIcon, CurrencyIcon, DAIIcon, DatepickerInput, DecimalsInput, DelphiPoolIcon, DependencyProvider, DialogContent, ETHIcon, AdaptiveGrid as Grid, HEGICIcon, HiddenSvgDefs, HistoryIcon, InfoIcon, Label, LiquidityAmountInput, MTAIcon, MUSDIcon, Metric, NetworkIcon, NumberInput, RENIcon, RadioButton, RadioGroupInput, RenBTCIcon, ResizeObserverComponent, ResizeObserverPolyfill, SBTCIcon, SNXIcon, SUSDIcon, SelectInput, ShortAddress, Skeleton, SteCRVIcon, SwitchInput, TUSDIcon, Tab, TabContext, TabList, index as Table, TabsSection, ThreeCrvIcon, TokenAmountInput, TokenIcon, TokenName, TokensIcons, USDCIcon, USDIcon, USDTIcon, WBTCIcon, WETHIcon, YCRVIcon, YFIIcon, YveCRVIcon };
